...
public class AggregationRepositoryTest {
  ...
  public void setUp() {
    ...
    blockedProduct1.setExpiresAt(LocalDate.now().plusYears(1));
    ...
    blockedProduct2.setExpiresAt(LocalDate.now().plusYears(1));
    ...
    blockedProduct3.setExpiresAt(LocalDate.now().plusYears(1));
    ...
    blockedProduct4.setExpiresAt(LocalDate.now().plusYears(1));
