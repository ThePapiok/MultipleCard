...
function atStart() {
    ...
    checkProvince(document.getElementById("province"), 4);
    checkStreet(document.getElementById("street"), 5);
    checkHouseNumber(document.getElementById("houseNumber"), 6);
    checkApartmentNumber(document.getElementById("apartmentNumber"), 7);
    checkPostalCode(document.getElementById("postalCode"), 8);
    checkCity(document.getElementById("city"), 9);
